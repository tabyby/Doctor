...
const ContactUs = () => {   
 ...
 function handleChange (e)  {
    ...
    function sendEmail(e){
        e.preventDefault();
        emailjs.sendForm('service_1orpeqa', 'template_g5eq5bw', form.current, '7Y7AXEoXIHpUfE--B')
        .then((result) => {
                        ...
                        <div className="div1 center">
                            <form ref={form} onSubmit={sendEmail} id="contact-form" className="form">
                                ...
                                <div className="form-group">
                                    ...
                                    <input name="email" value={values.email}  onChange={handleChange} type="email" className="form-control" aria-describedby="emailHelp" />
                                </div>
                                <div className="form-group">
                                    <label htmlFor="message">Message</label>
                                    <textarea name="message" value={values.message} onChange={handleChange}  className="form-control" rows="5"></textarea>
                                </div>
                                <br />
